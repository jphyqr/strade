...
//  }
     ...
     const MODEL_FACET =   `http://api.marketcheck.com/v1/search/recents?api_key=${MARKETCHECK_API_KEY}&${req.body.country}&dealer_id=${dealerId}&facets=model&rows=0${AND_OWNED_STRING}${AND_TYPE_STRING}`
   const config2 = {
        headers: {
          Host: "marketcheck-prod.apigee.net"
        }
